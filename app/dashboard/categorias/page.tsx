...
import { Categoria, categoriaSchema, addCategoria, subscribeToCategorias, updateCategoria, deleteCategoria } from "@/lib/services/categorias.services";
...
export default function CategoriasPage() {
    ...
    useEffect(() => {
        const unsubscribe = subscribeToCategorias(setCategorias);
        return () => unsubscribe();
    }, []);
    ...
    return (
        <CrudLayout
            ...
            tableContent={<GenericTable columns={columns} data={categorias} />}
        />
    );
}
