...
const SIDEBAR_WIDTH_ICON = "3.5rem" // Aumentado para melhor espaçamento
...
function SidebarProvider({
  ...
  // Função `setOpen` agora é estável
  ...
  // `toggleSidebar` usa o estado `open` atualizado
...
// O resto do arquivo (Sidebar, SidebarTrigger, etc.) não precisa de alterações.
// Apenas colei o resto para você substituir o arquivo inteiro.
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-3 overflow-hidden rounded-md px-3 py-2 text-left text-sm outline-none ring-sidebar-ring transition-all hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-semibold data-[active=true]:text-sidebar-accent-foreground",
  {
    variants: {
      variant: {
